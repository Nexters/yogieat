	...
	return (
		<div className="ygi:flex ygi:flex-col ygi:gap-md">
			...
			<div className="ygi:flex ygi:gap-sm">
				<button
					onClick={decrement}
					className="ygi:rounded-md ygi:bg-palette-gray-200 ygi:px-md ygi:py-xs ygi:body-14-md"
				>
					-10
				</button>
				<button
	...
	return (
		<div className="ygi:flex ygi:flex-col ygi:gap-xl ygi:p-xl">
			...
			<div className="ygi:flex ygi:flex-col ygi:gap-md">
				...
				<p className="ygi:body-14-md ygi:text-gray-500">
					단계를 시각화하여 표현한 것으로 진행 상태에 대한 피드백을
					사용자에게 전달합니다.
				</p>
			</div>
			...
			<div className="ygi:flex ygi:flex-col ygi:gap-md">
				...
				<div className="ygi:rounded-md ygi:bg-palette-gray-50 ygi:p-xl">
					<div className="ygi:flex ygi:items-center ygi:gap-xl">
			...
			{/* ProgressBar Section */}
			<div className="ygi:flex ygi:flex-col ygi:gap-md">
				<h2 className="ygi:heading-20-bd ygi:text-gray-900">
					Progress Bar
				</h2>

				<div className="ygi:gap-lg ygi:flex ygi:flex-col ygi:rounded-md ygi:bg-palette-gray-50 ygi:p-xl">
				...
				<div className="ygi:rounded-md ygi:bg-palette-gray-50 ygi:p-xl">
					<p className="ygi:mb-md ygi:body-14-md ygi:text-gray-500">
						Interactive Demo
					</p>
					<InteractiveProgress />
				</div>
